...
budgetPerDay:
  ...
  midRange: 70
  luxury: 190
gettingThere: "Fly into Bratislava Airport (BTS) or Vienna Airport (VIE, 60km away). Regular buses and trains connect both airports to the city centre. Direct trains from Vienna (1h), Budapest (2.5h), and Prague (4h)."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Continental — warm summers, cold winters" }
  - { icon: "💵", label: "Budget", value: "€25-190/day" }
  - { icon: "🗣️", label: "Language", value: "Slovak" }
highlights:
  - "Wander Bratislava's pastel-coloured Old Town and discover its playful bronze street sculptures"
  - "Climb to Bratislava Castle for commanding views over the Danube and three countries"
  - "Cross the futuristic UFO Bridge and dine at its observation deck restaurant 85 metres above the river"
...
affiliatePicks:
  - type: hotel
    provider: booking
    label: "Best-rated hotels in Bratislava"
    url: "https://www.booking.com/search.html?ss=bratislava&aid=1245953"
  - type: tour
    provider: gyg
    label: "Walking tours, castle tickets, and thermal bath entry"
    url: "https://www.getyourguide.com/s/?q=bratislava&partner_id=PARTNER"
  - type: transport
    provider: omio
