...
budgetPerDay:
  ...
  midRange: 80
  luxury: 220
gettingThere: "Fly into Budapest Ferenc Liszt Airport (BUD), then take the 100E airport bus directly to the city centre in about 35 minutes. Direct trains from Vienna (2.5h), Prague (7h), and Bratislava (2.5h)."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Continental — hot summers, cold winters" }
  - { icon: "💵", label: "Budget", value: "€25-220/day" }
  - { icon: "🗣️", label: "Language", value: "Hungarian" }
highlights:
  - "Soak in the grand Szechenyi Thermal Baths, one of Europe's largest public bathing complexes"
  - "Wander through the Buda Castle district and take in panoramic Danube views from Fisherman's Bastion"
  - "Experience Budapest's legendary ruin bar scene in the old Jewish Quarter"
gradientColors: "from-red-900 via-rose-800 to-pink-900"
relatedDestinations:
  - "prague"
  - "bratislava"
affiliatePicks:
