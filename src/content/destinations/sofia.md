...
budgetPerDay:
  ...
  midRange: 55
  luxury: 160
gettingThere: "Fly into Sofia Airport (SOF), just 10km east of the city center. Metro Line 1 connects the airport to downtown in 20 minutes for about €0.80. Taxis to the center cost around €8-10."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Continental — warm summers, snowy winters" }
  - { icon: "💵", label: "Budget", value: "€20-55/day" }
  - { icon: "🗣️", label: "Language", value: "Bulgarian" }
highlights:
  - "Alexander Nevsky Cathedral — a gold-domed masterpiece and one of the largest Eastern Orthodox cathedrals in the world"
  - "Vitosha Mountain — hiking and skiing just 30 minutes from the city center"
  - "Boyana Church — a UNESCO World Heritage Site with medieval frescoes predating the Italian Renaissance"
gradientColors: "from-rose-900 via-pink-800 to-fuchsia-900"
relatedDestinations:
  - "bucharest"
  - "belgrade"
affiliatePicks:
